        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-green-100 mb-6">
              The world's first truly hands-free budgeting app that lets you track expenses
              by simply speaking to your phone.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#how" className="text-green-100 hover:text-white transition-colors">How It Works</a>
              </li>
              <li>
                <a href="#pricing" className="text-green-100 hover:text-white transition-colors">Pricing</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/terms" className="text-green-100 hover:text-white transition-colors">Terms of Service</a>
              </li>
              <li>
                <a href="/privacy" className="text-green-100 hover:text-white transition-colors">Privacy Policy</a>
              </li>
              <li>
                <a href="/refund-policy" className="text-green-100 hover:text-white transition-colors">Refund Policy</a>
              </li>
            </ul>
          </div>
        </div>
